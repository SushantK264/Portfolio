...
const projectsData = [
  ...
  {
    emoji: '🗓️',
    tags: ['Mendix Studio Pro', 'Microflows', 'Nanoflows', 'XPath'],
    title: 'Leave Management System',
    desc: 'A low-code Leave Management System built on Mendix Studio Pro during internship at Three M Software Pvt. Ltd., handling organizational leave workflows end-to-end.',
    bullets: [
      'Implemented Employee, Manager, and HR role-based access control.',
      'Developed leave application, approval, rejection, and status tracking workflows.',
      'Created domain models, microflows, XPath constraints, and validations.',
      'Implemented leave overlap validation and working-day calculations.',
      'Automated leave approval and employee leave tracking processes with email notifications.',
    ],
    link: '#',
    linkLabel: 'GitHub',
    isLive: false,
...
const certsData = [
  ...
  { icon: '🧭', title: 'Mendix Rapid Developer Certification', issuer: 'Mendix', image: './images/mendix-certificate.jpg', type: 'mendix' },
...
const expCerts = {
  ...
  mendix: { title: 'Mendix Rapid Developer Certification', issuer: 'Mendix', image: './images/mendix-certificate.jpg' },
};
  ...
  g.innerHTML = projectsData.map((p, i) => `
    <div class="pcard reveal" style="transition-delay:${i * .1}s">
      ...
      <div class="pcard-body">
        ...
        <div class="plinks">
          ${p.disabled
      ? `<span class="plink plink-disabled" title="Coming soon">
